...
class CustomerOrderDetail extends StatefulWidget {
  ...
  const CustomerOrderDetail({this.orderModel});
  @override
...
class _CustomerOrderDetailState extends State<CustomerOrderDetail> {
  static List<String> orderStatus = <String>[
    'In Progress', 'Shipped' , 'On The Way',
  ];
  String _selectedLocation =orderStatus.first;
  @override
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 25),
                    Visibility(
                      visible: (widget.orderModel.paymentStatus == 'pending') ? true :false,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton(
                      ...
                      items: orderStatus.map((location) {
                    ...
                    child: CustomRoundedButton(title: 'Update Status',
                      clickFuction: (){
                        orderController.updateOrder({
                          'Order Status' : _selectedLocation,
                        }, widget.orderModel,
                          _selectedLocation
                        ).whenComplete(() {
                          Get.back();
